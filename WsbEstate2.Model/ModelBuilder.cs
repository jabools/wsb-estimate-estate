...
namespace WsbEstate2.Model
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"../WsbEstate2.Model/data.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Categorical.OneHotEncoding(new[]
                {
                    new InputOutputColumnPair("Type", "Type"), new InputOutputColumnPair("YearBuilt", "YearBuilt"),
                    new InputOutputColumnPair("Beds", "Beds"), new InputOutputColumnPair("GarageType", "GarageType"),
                    new InputOutputColumnPair("GarageSpaces", "GarageSpaces")
                })
                .Append(mlContext.Transforms.Concatenate("Features",
                    new[]
                    {
                        "Type", "YearBuilt", "Beds", "GarageType", "GarageSpaces", "Area", "Zip", "Baths",
                        "ParkingSpaces"
                    }));
            // Set the training algorithm 
            var trainer =
                mlContext.Regression.Trainers.FastTree(labelColumnName: "SoldPrice", featureColumnName: "Features");
            ...
            IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.Regression.CrossValidate(trainingDataView, trainingPipeline,
                numberOfFolds: 5, labelColumnName: "SoldPrice");
